...
// console.log(x);
// x = "oi";
// Não imprime porque a variável x foi declarada depois do console.log
// Para funcionar pode se criar uma função que pode ser executada em qualquer momento
...
imprimir("Oi, eu sou o texto impresso pela função imprimir");
imprimir("Oi, eu sou outro texto escrito pela mesma função imprimir");

// Três formas de escrever funções

function soma() {
    return 2 + 2; // return só executara o que vem antes dele
                  // o que vem depois do return não fará parte dele 
}
